...
const navLinks = [
  ...
  { displayName: "Education", name: "education", href: "#education" },
    ...
    <div className="fixed w-full z-100">
      ...
      <div className="md:hidden fixed top-5 right-5 z-50">
        <button
          ...
          className="p-3 rounded-full shadow-lg hover:bg-gray-200 active:bg-gray-300 focus:outline-hidden transition-all duration-300"
      ...
      {/* Mobile Menu */}
      {/* Overlay */}
      <div className={nav ? "md:hidden fixed left-0 top-0 w-full h-screen bg-black/70" : ""} onClick={() => setNav(false)}>
        <div
          onClick={(e) => e.stopPropagation()}
          className={
            nav
              ? "fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#f9fafb] p-10 ease-in duration-500"
        ...
        >
          <div className="flex items-center justify-between p-6 border-b border-gray-100">
            <div className="flex items-center gap-3">
              ...
              <h2 className="font-semibold text-[#9a4ce7]">Welcome</h2>
            </div>
          </div>
              ...
              >
                <div
                  className={`mb-3 rounded-lg px-4 py-3 transition-all duration-200 ${
                    activeLink === link.name
                      ? "bg-purple-50 text-[#9a4ce7] font-medium text-lg shadow-xs"
                      : "text-gray-600 hover:bg-gray-50 hover:text-[#9a4ce7]"
                  }`}
                >
                  {link.displayName}
                </div>
